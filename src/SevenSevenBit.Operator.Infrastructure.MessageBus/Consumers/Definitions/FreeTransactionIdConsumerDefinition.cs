...
/// <summary>
/// Configure the behaviour of a consumer of type <see cref="FreeTransactionIdConsumer"/>.
...
public class FreeTransactionIdConsumerDefinition
    : ConsumerDefinition<FreeTransactionIdConsumer>
{
    private readonly MessageBusOptions messageBusOptions;

    /// <summary>
    /// Initializes a new instance of the <see cref="FreeTransactionIdConsumerDefinition"/> class.
    /// </summary>
    /// <param name="messageBusOptions">The message bus options to be used for configuration.</param>
    public FreeTransactionIdConsumerDefinition(IOptions<MessageBusOptions> messageBusOptions)
    {
        ...
        EndpointName = messageBusOptions.Value.Endpoints!.FreeTransactionId!;
    }

    /// <inheritdoc />
    protected override void ConfigureConsumer(
        IReceiveEndpointConfigurator endpointConfigurator,
        IConsumerConfigurator<FreeTransactionIdConsumer> consumerConfigurator)
    {
