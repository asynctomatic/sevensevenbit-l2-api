...
public static class Users
{
    ...
    public static readonly User Badjoras123 = new()
    {
    ...
    public static readonly User Badjoras1234 = new()
    {
    ...
    public static readonly User BitMexArthur = new()
    {
        Id = Guid.NewGuid(),
    ...
    {
        yield return Badjoras123;
        yield return Badjoras1234;
        yield return BitMexArthur;
    }
}