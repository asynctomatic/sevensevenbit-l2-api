...
public class WithdrawalModelComparer : IEqualityComparer<WithdrawalModel>
{
    public bool Equals(WithdrawalModel x, WithdrawalModel y)
    {
    ...
    public int GetHashCode(WithdrawalModel obj)
    {
